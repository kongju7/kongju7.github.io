---
layout: post
title: 데이터 과학자가 되기 위해 필요한 지식이나 능력
subtitle: 도메인 지식, 수학, 컴퓨터 과학, 의사소통 능력 
...
그럼 데이터 과학자가 되기 위해서는 어떤 순서대로 공부를 하면 좋을까요? 
  
## 데이터 과학자가 되기 위해 필요한 지식이나 능력을 쌓기 위한 공부 순서  
  
데이터 과학자가 되기 위해서 어떤 부분이 필요한지 확인하는 **체크리스트**로도 활용해 보세요. 
